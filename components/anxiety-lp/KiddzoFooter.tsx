...
export default function KiddzoFooter() {
  return <footer className="relative min-h-[625px] overflow-hidden bg-white font-sans text-black">
    ...
    <div className="relative z-10 mx-auto grid max-w-[1490px] grid-cols-2 gap-x-3 gap-y-6 max-sm:gap-y-3 px-6 pb-0 pt-10 sm:gap-3 sm:px-8 lg:grid-cols-[1.1fr_.8fr_.9fr_1.35fr] lg:gap-12 lg:pt-[36px]">
      <Reveal as="section" direction="left" className="col-span-2 sm:col-span-1">
        <BHomeoLogo/>
      ...
      <Reveal as="nav" direction="up" delay={100} aria-label="Quick links">
        <h3 className="text-[22px] max-sm:text-[20px] font-extrabold text-[#000d44]">Quick Links</h3>
        <ul className="mt-5 max-sm:mt-2 max-sm:space-y-1 space-y-3 text-[15px]"><li><a className="hover:text-[#1f5fff] max-sm:mb-1" href="#">Home</a></li><li><a className="hover:text-[#1f5fff]" href="#about">About Us</a></li><li><a className="hover:text-[#1f5fff]" href="#programme">ADHD Care</a></li><li><a className="hover:text-[#1f5fff]" href="#services">Services</a></li><li><a className="hover:text-[#1f5fff]" href="#faq">FAQs</a></li><li><a className="hover:text-[#1f5fff]" href="#contact">Contact</a></li></ul>
      </Reveal>

      <Reveal as="section" direction="up" delay={200} id="contact">
        <h3 className="text-[22px] max-sm:text-[20px] font-extrabold text-[#000d44]">Get In Touch</h3>
        <div className="mt-5 max-sm:mt-2 space-y-4 max-sm:space-y-1 text-[15px] leading-6"><p><span className="block font-bold text-[#000d44]">Address</span><span>Near Jalna Mahanagarpalika, Jalna, Maharashtra – 431203</span></p><p><span className="block font-bold text-[#000d44]">Email</span><a className="hover:text-[#1f5fff]" href="mailto:admin@bhomeo.in">admin@bhomeo.in</a></p><p><span className="block font-bold text-[#000d44]">Phone</span><a className="hover:text-[#1f5fff]" href="tel:+917719996771">+91 7719996771</a></p></div>
      </Reveal>
    </div>
