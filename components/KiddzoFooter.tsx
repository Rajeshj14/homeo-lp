...
export default function KiddzoFooter() {
  return <footer className="relative min-h-[625px] overflow-hidden bg-white font-sans text-black">
    ...
    <div className="relative z-10 mx-auto grid max-w-[1490px] gap-3 px-6 pb-0 pt-10 sm:grid-cols-2 sm:px-8 lg:grid-cols-[1.1fr_.8fr_.9fr_1.35fr] lg:gap-12 lg:pt-[36px]">
      <section>
        <BHomeoLogo/>
